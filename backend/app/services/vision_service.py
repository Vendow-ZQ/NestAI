...
---JSON_START---
{"questions":[{"q":"你最向往这个空间支持哪种生活状态和生活方式？","options":["更快进入专注","回来后更容易放松","更好展示个人物品","更容易保持整洁"]},{"q":"现在这个空间和你向往的生活状态最不匹配的是哪里？","options":["想专注，但桌面或地面容易打断启动","想放松，但工作和休息物品混在一起","想表达自己，但展示物和常用工具互相挤压","想顺手生活，但常用物缺少稳定收尾位置"]},{"q":"这次改造最重要的约束是什么？","options":["低预算，优先复用现有物品","标准预算，可以买几件关键小物","预算充足，希望做完整一点","只能无痕调整，尽量不移动大件"]}]}
---JSON_END---"""
...
- 第 1 题确认用户向往的生活状态和生活方式。
- 第 2 题确认当前空间与这种生活状态/生活方式最不匹配的地方。
- 第 3 题确认改造约束。
