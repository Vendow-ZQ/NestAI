...
---JSON_START---
{"questions":[{"q":"你最希望这个空间先支持哪种生活状态？","options":["更快进入专注","回来后更容易放松","更好展示个人物品","更容易保持整洁"]},{"q":"现在最影响你使用这个空间的是什么？","options":["桌面或地面容易堆东西","光线不够舒服","动线或取物不顺手","休息和工作边界不清"]},{"q":"这次改造最重要的约束是什么？","options":["低预算，优先复用现有物品","标准预算，可以买几件关键小物","预算充足，希望做完整一点","只能无痕调整，尽量不移动大件"]}]}
---JSON_END---"""
